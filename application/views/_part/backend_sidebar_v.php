...
<div id="wrapper">
  ...
  <!-- Sidebar -->
  <ul class="navbar-nav nada sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand" href="index.html">
      ...
      <img src="<?= base_url() ?>assets/img/basic.png" alt="" width="100">
    </a>
